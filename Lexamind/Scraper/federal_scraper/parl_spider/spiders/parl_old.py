...
class ParlSpider(Spider):
    ...
    # start_urls = ['http://www.parl.ca/LegisInfo/BillDetails.aspx?Language=E&billId=8804045']
    ...
    def parse_bill(self, response):
        bill_name = response.xpath(
            '//*[@id="ctl00_ParlSessControl_lblParliamentSession"]/text()').extract_first()
        ...
        latest_publication = response.xpath(
            '//a[text()="Latest Publication"]/@href').extract_first()
