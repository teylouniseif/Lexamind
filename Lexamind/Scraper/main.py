...
x.addLaw("Loi sur le financement des petites entreprises (Canada)")
x.addLaw("Loi canadienne sur les sociétés par actions (Canada)")
x.addLaw("Loi sur la publicité légale des entreprises (Québec)")
x.addLaw("Loi sur les sociétés par actions (Québec)")
x.addLaw("Franchise Act (C-B)")
x.addLaw("Loi électorale du Canada (Canada)")
x.addLaw("Loi concernant le financement des partis politiques (Québec)")
...
x.addLaw("Code civil du Québec (Québec)")
...
x.addLaw("Loi sur la marine marchande du Canada (Canada)")
